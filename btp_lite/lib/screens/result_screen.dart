        ...
        header: (_) => pw.Container(
          ...
          child: pw.Column(
            ...
            children: [
              ...
              pw.Text(
                'Generated by MedSimplify Lite  ·  $dateStr  ·  Model: ${result.modelName}',
                style: const pw.TextStyle(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            tooltip: 'Share',
            onPressed: () => Share.share(result.simplifiedText,
            ...
            Wrap(
              ...
              children: [
                ...
                if (result.tokensUsed != null)
                  _MetaChip(
                    label: '${result.tokensUsed} tokens',
                    color: subColor,
                    isLight: true,
                  ),
                _MetaChip(
